...
#define RFX_D_PRIME_BOOST_CAP_PCT	75
 ...
 * Gaming 90%: midpoint. 87% chased fmax too eagerly -- more frame-to-frame OPP
 * churn (jank 0.5->1.3%) and voltage spikes (power off 5.9W); 92% held heavy
 * frames one OPP short (116fps). 90% reaches fmax on true saturation without
 * churning the steady band. Daily 95%: last OPP is a battery cost. */
